...
if(isset($_SESSION['user'])){
  ...
  header('Location:?c=login&error=loginfirst');
}
    ...
    <div class="container shoppingCart">
      ...
      <div class="row">
        <div class="shopping-title">
          <h1><?php echo $loginUser; ?></h1>
          <h3>Shopping Cart</h3>
		  <button class="btn btn-danger btn-sm" onclick = "location.href='?c=shoppingcartedit'"><i class="fa fa-trash-o">Edit</i></button>
        ...
        <div class="col-12 col-md-8 one">
          <table class="table table-hover table-condensed">
            ...
            <tr>
              ...
              <th style="width:10%" class="text-center">Subtotal (AUD)</th>
		...
		$totalPrice = ($selectedProduct[$i]["price"] * $selectedProduct[$i]["quantity"])+$totalPrice;
          ...
          <tfoot>
            ...
            <td><a href="?c=look" class="btn btn-success btn-block hidden-xs">Continue Shopping<i class="fa fa-angle-right"></i></a></td>
            </tr>
          </tfoot>
  ...
  <div class="col-6 col-md-4 side">
    <div class="summary">
        ...
        <div class="summary-subtotal">
          ...
          <div class="total-title" style="font-size:22px;">Total (AUD): </div>
		  <?php
...
<div id="success" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="?c=checkorder" class="btn btn-default btn-sm">Check Order</a>
      </div>
    </div>
